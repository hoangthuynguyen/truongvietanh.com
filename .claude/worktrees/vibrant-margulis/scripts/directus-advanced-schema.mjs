...
async function run() {
  ...
  const campuses = [
    ...
    { name: 'Trường Mầm non Việt Anh Gò Vấp', city: 'TP. Hồ Chí Minh', address: '573 Đ. Lê Đức Thọ, Phường An Hội Tây', phone: '0774 588 988', levels: ['mam-non'], sort: 4, status: 'published' },
