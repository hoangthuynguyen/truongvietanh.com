...
.form-label{{display:block;font-size:11px;font-weight:700;color:#666;text-transform:uppercase;letter-spacing:.5px;margin-bottom:6px}}
.form-input{{
...
.btn-cta{{
  ...
  font-weight:900;font-size:16.5px;border:none;border-radius:11px;
...
.guarantee{{text-align:center;font-size:10.5px;color:#aaa;margin-top:8px}}

/* ── STEP BAR ── */
.step-bar{{display:flex;align-items:center;gap:8px;padding:12px 18px 0}}
.step-item{{display:flex;align-items:center;gap:5px;font-size:11.5px;font-weight:600;color:#bbb}}
.step-item.active{{color:#0d1b3e}}
.step-item.done{{color:#22c55e}}
.step-num{{width:21px;height:21px;border-radius:50%;background:#e5e7eb;color:#888;font-size:11px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0}}
...
.btn-back{{background:none;border:none;color:#999;font-size:12px;cursor:pointer;padding:6px 0 0;display:flex;align-items:center;gap:4px;font-family:inherit}}
  ...
  <div class="right">
    ...
    <div class="card" id="mainCard">
      ...
      <div class="card-body" id="step1">
        ...
        <p class="guarantee">🔒 Bảo mật · Không spam · Huỷ bất cứ lúc nào</p>
      </div>
      ...
      <div class="card-body" id="step2" style="display:none">
        ...
        <input class="form-input" type="text" id="sq-name"
               placeholder="Nguyễn Thị An" autocomplete="name" style="margin-bottom:10px"/>
      ...
      <div class="success-box" id="sqSuccess">
        ...
        <p>Kiểm tra email ngay —<br>tài liệu gửi trong vài phút.<br><strong>Nhớ kiểm tra Spam / Promotions</strong></p>
      </div>
    </div>
  </div>
