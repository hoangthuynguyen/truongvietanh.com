...
const FACTS = [
  ...
  ['Tên phường', 'An Hội Đông', '⚠ Đã sửa 26/08 theo xác nhận. Trang cũ ghi An Hội Tây. CẦN XÁC NHẬN thêm: P.16 cũ có phải là An Hội Đông không?'],
  ['Cơ sở liên cấp', '160/72 Phan Huy Ích, Phường An Hội Tây, Gò Vấp', 'Đã xác nhận 26/08. Khác phường với cơ sở mầm non.'],
