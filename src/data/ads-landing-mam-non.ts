...
export const adsPages: AdsPage[] = [
  // ─────────────────────────────── AG 01 ───────────────────────────────
  {
    ...
    title: 'Trường Mầm Non Gò Vấp Gần Nhà — 573 Lê Đức Thọ | Trường Việt Anh',
...
<section class="sec">
  ...
  // ─────────────────────────────── AG 03 ───────────────────────────────
  {
    ...
    title: 'Học Phí Mầm Non Gò Vấp 2026 — Bảng Giá Đầy Đủ, Không Phí Ẩn',
    ...
    eyebrow: 'Học phí 2026 · Mầm non Gò Vấp',
...
<section class="sec">
  ...
  // ─────────────────────────────── AG 07 ───────────────────────────────
  {
    ...
    title: 'Mầm Non Gò Vấp Có Camera Cho Phụ Huynh, Lớp Nhỏ, Bếp Nấu Tại Trường',
...
<section class="sec">
  ...
  // ─────────────────────────────── AG 08 ───────────────────────────────
  {
    ...
    title: 'Chọn Trường Mầm Non Gò Vấp — Học Tập Chủ Động, Montessori Hay Truyền Thống?',
...
<section class="sec">
  ...
  // ─────────────────────────────── AG 09 ───────────────────────────────
  {
    ...
    title: 'Tham Quan & Học Thử Mầm Non Gò Vấp — Miễn Phí, Không Ràng Buộc',
